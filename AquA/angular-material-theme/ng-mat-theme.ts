...
class AngularMaterialTheme implements AngularMaterialTheme {
  ...
  getColor(str: 'primary' | 'accent'): string {
    return this[str].palette[this.primary.id].hex;
  }
}

const ArizonaTheme: AngularMaterialTheme = new AngularMaterialTheme(
  'arizona', { palette: Brown, id: '400' }, {palette: Teal, id: '300'});

const CorporateTheme: AngularMaterialTheme = new AngularMaterialTheme(
  'corporate', { palette: BlueGray, id: '500' }, {palette: Gray, id: '400'});

const LushTheme: AngularMaterialTheme = new AngularMaterialTheme(
  'lush', { palette: Green, id: '800' }, {palette: LightGreen, id: '300'});

const PirateTheme: AngularMaterialTheme = new AngularMaterialTheme(
  'pirate', { palette: Gray, id: '900' }, {palette: Red, id: '900'});
